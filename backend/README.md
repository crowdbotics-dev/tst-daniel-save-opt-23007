...
## Project Structure
    ...
    ├── tst_daniel_save_opt_23007  # Django project configurations
...
1. Clone this repo and `cd tst_daniel_save_opt_23007`
...
2. Clone this repo and `cd tst_daniel_save_opt_23007`
